...
func DeleteproxyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteproxyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_proxy",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteproxyHandler(cfg),
	}
}
