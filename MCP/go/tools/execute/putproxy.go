...
func PutproxyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePutproxyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_proxy",
		mcp.WithDescription("PUT"),
