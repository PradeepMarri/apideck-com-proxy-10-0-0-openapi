...
func GetproxyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetproxyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_proxy",
		mcp.WithDescription("GET"),
