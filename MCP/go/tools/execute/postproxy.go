...
func PostproxyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePostproxyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_proxy",
		mcp.WithDescription("POST"),
