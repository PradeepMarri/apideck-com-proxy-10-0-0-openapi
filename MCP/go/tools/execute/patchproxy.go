...
func PatchproxyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchproxyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_proxy",
		mcp.WithDescription("PATCH"),
